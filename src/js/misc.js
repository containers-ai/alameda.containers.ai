  ...
  (function($) {
    ...
    $(document).ready(function() {
      ...
      $('[data-toggle="offcanvas"]').on("click", function() {
        ...
        $(this)
          .children("i.fa")
          .toggleClass("fa-flip-horizontal");
      });
      ...
      $(document).on("mouseenter", "pre", function() {
        $(this)
          .next()
          .toggleClass("copy-show", true);
        $(this)
          .next()
          .toggleClass("copy-hide", false);
      });
      ...
      $(document).on("mouseleave", "pre", function() {
        $(this)
          .next()
          .toggleClass("copy-show", false);
        $(this)
          .next()
          .toggleClass("copy-hide", true);
      });
    ...
    function attachCopyButtons() {
      ...
      var copyCode = new Clipboard("button.copy", {
        text: function(trigger) {
          var commands = trigger.previousElementSibling.getElementsByClassName(
            "command"
          );
      ...
      for (var i = 0; i < pre.length; i++) {
        ...
        if (cl !== "") {
          ...
          for (var j = 0; j < lines.length; j++) {
            ...
            if (line.startsWith("$ ")) {
              if (tmp !== "") {
                cmd +=
                  "$ " +
                  Prism.highlight(tmp, Prism.languages["bash"], "bash") +
                  "\n";
              }
          ...
          if (cmd !== "") {
            cmd = cmd.replace(
              /@(.*?)@/g,
              "<a href='https://raw.githubusercontent.com/containers-ai/alameda" +
                branchName +
                "/$1'>$1</a>"
            );
    ...
    function createEndnotes() {
      ...
      for (var i = 0; i < links.length; i++) {
        ...
        link.insertAdjacentHTML(
          "afterend",
          "<sup class='endnote-ref'>" + count + "</sup>"
        );
      }
    }
